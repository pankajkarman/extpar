...
netcdf_output_filename='extpar_euro-cordex_12km_globe.nc'

# Output directory (-> ensure that this location provides enough disk space)
sandboxdir=/scratch/snx3000/csteger/EXTPAR/output/euro-cordex_12km
...
# (only required for 'lscale_separation = .TRUE.')
...
# Files with precomputed SGSL (if lpreproc_oro = .FALSE.)
...
# Names of generated SGSL files (if lpreproc_oro = .TRUE.)
#raw_data_sgsl_A10='S_ORO_A10_own.nc'
#raw_data_sgsl_B10='S_ORO_B10_own.nc'
#raw_data_sgsl_C10='S_ORO_C10_own.nc'
#raw_data_sgsl_D10='S_ORO_D10_own.nc'
#raw_data_sgsl_E10='S_ORO_E10_own.nc'
#raw_data_sgsl_F10='S_ORO_F10_own.nc'
#raw_data_sgsl_G10='S_ORO_G10_own.nc'
#raw_data_sgsl_H10='S_ORO_H10_own.nc'
#raw_data_sgsl_I10='S_ORO_I10_own.nc'
#raw_data_sgsl_J10='S_ORO_J10_own.nc'
#raw_data_sgsl_K10='S_ORO_K10_own.nc'
#raw_data_sgsl_L10='S_ORO_L10_own.nc'
#raw_data_sgsl_M10='S_ORO_M10_own.nc'
#raw_data_sgsl_N10='S_ORO_N10_own.nc'
#raw_data_sgsl_O10='S_ORO_O10_own.nc'
#raw_data_sgsl_P10='S_ORO_P10_own.nc'
...
&orography_raw_data
 ...
 ntiles_row = 4,
 topo_files = \
'${raw_data_globe_A10}' '${raw_data_globe_B10}' '${raw_data_globe_C10}' \
...
&sgsl_io_extpar
 ...
 sgsl_files = \
'${raw_data_sgsl_A10}' '${raw_data_sgsl_B10}' '${raw_data_sgsl_C10}' \
'${raw_data_sgsl_D10}' '${raw_data_sgsl_E10}' '${raw_data_sgsl_F10}' \
'${raw_data_sgsl_G10}' '${raw_data_sgsl_H10}' '${raw_data_sgsl_I10}' \
'${raw_data_sgsl_J10}' '${raw_data_sgsl_K10}' '${raw_data_sgsl_L10}' \
'${raw_data_sgsl_M10}' '${raw_data_sgsl_N10}' '${raw_data_sgsl_O10}' \
'${raw_data_sgsl_P10}'
    /
EOF_oro
...
&scale_separated_raw_data
  ...
  scale_sep_files = \
'${raw_filt_globe_A10}' '${raw_filt_globe_B10}' '${raw_filt_globe_C10}' \
'${raw_filt_globe_D10}' '${raw_filt_globe_E10}' '${raw_filt_globe_F10}' \
'${raw_filt_globe_G10}' '${raw_filt_globe_H10}' '${raw_filt_globe_I10}' \
'${raw_filt_globe_J10}' '${raw_filt_globe_K10}' '${raw_filt_globe_L10}' \
'${raw_filt_globe_M10}' '${raw_filt_globe_N10}' '${raw_filt_globe_O10}' \
'${raw_filt_globe_P10}'
/
EOF_scale_sep
