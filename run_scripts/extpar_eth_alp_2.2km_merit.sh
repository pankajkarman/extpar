...
netcdf_output_filename='extpar_alp_2.2km_merit.nc'

# Output directory (-> ensure that this location provides enough disk space)
sandboxdir=/scratch/snx3000/csteger/EXTPAR/output/alp_2.2km
...
# MERIT digital elevation model (AlP domain)
...
# Names of generated SGSL files (AlP domain)
...
&orography_raw_data
 ...
 ntiles_row = 1,
 topo_files = \
'${raw_data_merit_N60_N30_W030_E000}' '${raw_data_merit_N60_N30_E000_E030}' 
/
&sgsl_io_extpar
 lpreproc_oro=.TRUE.,
 sgsl_buffer_file='sgsl_buffer.nc',
 sgsl_files = \
'${raw_data_sgsl_N60_N30_W030_E000}' '${raw_data_sgsl_N60_N30_E000_E030}'
    /
EOF_oro
