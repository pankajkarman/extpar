...
extpar_ei_t2m = extpar_ei.createVariable('T_2M_CLIM', np.float32, (
    'time',
    'ke',
    'je',
    'ie',
...
extpar_ei_t2m[:, :, :, :] = np.reshape(ei.variables['T_2M_CLIM'][:, :],
                                       (12, 1, 1, cells))

extpar_ei_topo = extpar_ei.createVariable('TOPO_CLIM', np.float32, (
    'ke',
    'je',
    'ie',
))
...
extpar_ei_topo[:, :, :] = np.reshape(ei_oro.variables['TOPO_CLIM'][:, :],
                                     (1, 1, cells))
