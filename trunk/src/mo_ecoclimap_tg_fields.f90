...
PUBLIC :: fr_land_ecoclimap, &
       ...
       REAL (KIND=wp), ALLOCATABLE  :: ecoclimap_class_fraction(:,:,:,:)  !< fraction for each ecoclimap class on target grid (dimension (ie,je,ke,nclass_ecoclimap))

       INTEGER (KIND=i8), ALLOCATABLE :: ecoclimap_class_npixel(:,:,:,:) !< number of raw data pixels for each ecoclimap class on target grid (dimension (ie,je,ke,nclass_ecoclimap))


       INTEGER (KIND=i8), ALLOCATABLE :: ecoclimap_tot_npixel(:,:,:)  !< total number of ecoclimap raw data pixels on target grid (dimension (ie,je,ke))
