...
\begin{itemize}
  ...
  \item INPUT\_ISA
  \item INPUT\_AHF
  \item INPUT\_OROSMOOTH
  \item INPUT\_RADTOPO
  \item INPUT\_SCALE\_SEP
...
\subsection{Workflow Python}\label{Workflow Python}
...
\begin{itemize}
  ...
  \item data output: buffer file with albedo data (input\_alb: alb\_output\_file)
\end{itemize}
...
The currently used algorithm in the Fortran modules aggregates source grid point
...
To resolve this issue, a rewrite of those Fortran module in Python, using the more sophisticated interpolation methods
...
\item \textbf{emissivity} \textit{first order conservativ remappinf}
\end{itemize}
