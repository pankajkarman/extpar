...
\noindent Since Exptar Version 5.4 a new feature allows to run the
extpar\_consistency\_check even for very high resolution global
grids. A POSIX mmap based implemetation of disk caching arrays is
...
Since Extpar Version 5.4 the output possibilities have been extended for ICON. 
...
prepare for future developments is provided. For a detailed description of
CDI look at \\
