...
MODULE mo_glc2000_lookup_tables
  ...
  PUBLIC :: init_glc2000_lookup_tables, &
       ...
       &    i_gme_lookup_table, i_cosmo_lookup_table, i_experimental_lookup_table, &
  ...
  INTEGER (KIND=i4), PARAMETER :: nclass_glc2000 = 23, & !< GLC2000 has 23 classes for the land use description
       &                          i_gme_lookup_table = 1, & !< lookup_table for GLC2000 land use classes (IGBP correspondence) from
       &                          i_cosmo_lookup_table = 2, & !< lookup_table for GLC2000 land use classes (IGBP correspondence) from
       &                          i_experimental_lookup_table = 3 !< lookup_table for GLC2000 land use classes


  REAL (KIND=wp)               :: z0_lt_glc2000(nclass_glc2000), &      !< lookup table landuse class to roughness length [m]
       &                          lnz0_lt_glc2000(nclass_glc2000), &    !< corresponding natural logarithm of z0c_gme_o
       &                          plc_mn_lt_glc2000(nclass_glc2000), &  !< lookup table landuse class to minimal plant cover
       &                          plc_mx_lt_glc2000(nclass_glc2000), &  !< lookup table landuse class to maximal plant cover
       &                          lai_mn_lt_glc2000(nclass_glc2000), &  !< lookup table landuse class to minimal leaf area index
       &                          lai_mx_lt_glc2000(nclass_glc2000), &  !< lookup table landuse class to maximal leaf area index
       &                          rd_lt_glc2000(nclass_glc2000), &      !< lookup table landuse class to root depth [m]
       &                          emiss_lt_glc2000(nclass_glc2000), &   !< lookup table landuse class to surface thermal emissivity
       &                          rs_min_lt_glc2000(nclass_glc2000)  !< lookup table landuse class to minimal stomata resistance
  ...
  SUBROUTINE init_glc2000_lookup_tables(nclass_glc2000, &
    ...
    INTEGER(KIND=i4), INTENT(IN) :: nclass_glc2000, & !< GLC2000 has 23 classes for the land use description
         &                          ilookup_table_glc2000  !< integer switch to choose a lookup table

    REAL (KIND=wp), INTENT(OUT)  :: z0_lt_glc2000(nclass_glc2000), &      !< lookup table landuse class to roughness length [m]
         &                          lnz0_lt_glc2000(nclass_glc2000), &    !< corresponding natural logarithm of z0c_gme_o
         &                          plc_mn_lt_glc2000(nclass_glc2000), &  !< lookup table LU class to minimal plant cover
         &                          plc_mx_lt_glc2000(nclass_glc2000), &  !< lookup table LU class to maximal plant cover
         &                          lai_mn_lt_glc2000(nclass_glc2000), &  !< lookup table LU class to minimal leaf area index
         &                          lai_mx_lt_glc2000(nclass_glc2000), &  !< lookup table LU class to maximal leaf area index
         &                          rd_lt_glc2000(nclass_glc2000), &      !< lookup table LU class to root depth [m]
         &                          emiss_lt_glc2000(nclass_glc2000), &   !< lookup table LU class to surface thermal emissivity
         &                          rs_min_lt_glc2000(nclass_glc2000)  !< lookup table LU class to minimal stomata resistance
  ...
  SUBROUTINE get_name_glc2000_lookup_tables(ilookup_table_glc2000, name_lookup_table_glc2000)
    ...
    INTEGER(KIND=i4), INTENT(IN)              :: ilookup_table_glc2000  !< integer switch to choose a lookup table
