...
MODULE mo_agg_sgsl
  ...
  CONTAINS
   ...
   TYPE(reg_lonlat_grid) :: sgsl_tiles_grid(1:ntiles)!< structure with defenition of the raw data grid for the 16/36 GLOBE/ASTER tiles
   TYPE(target_grid_def), INTENT(IN)      :: tg              !< !< structure with target grid description

   TYPE(reg_lonlat_grid) :: sgsl_grid                !< structure with defenition of the raw data grid for the whole GLOBE/ASTER dataset
...
!< structure with definition of the raw data grid for the whole slope dataset
    TYPE(reg_lonlat_grid), INTENT(IN) :: sgsl_tiles_grid(1:ntiles) !< structure with definition of the raw data grid for the 16/36 GLOBE/ASTER tiles
    INTEGER (KIND=i4), INTENT(IN)     :: ncids_sgsl(1:ntiles)  !< ncid for the sgsl tiles, the netcdf files have to be opened by a previous call of open_netcdf_GLOBE_tile
